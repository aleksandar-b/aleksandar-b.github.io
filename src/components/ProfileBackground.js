        ...
        >
            ...
            />
                <circle
                    ...
                    style={{
                        animation: 'circle-small-scale 3s ease-in-out 3.2s infinite alternate',
                    }}
                    fill="none"
                    cx="50%"
                    cy="50%"
                ...
                <circle
                    ...
                    style={{
                        animation:
                            'circle-small-scale 3s ease-in-out 2.9s infinite alternate',
                    }}
                    fill="#fdc50f"
                    cx="50%"
                    cy="50%"
                ...
                <circle
                    ...
                    className="prefix__puls"
                    style={{
                        animation: 'circle-small-scale 3s ease-in-out 2.6s infinite alternate',
                    }}
                    fill="none"
                    cx="50%"
                    cy="50%"
                ...
                <circle
                    ...
                    className="prefix__puls"
                    style={{
                        animation: 'circle-small-scale 3s ease-in-out 2.3s infinite alternate',
                    }}
                    fill="#f9a81a"
                    cx="50%"
                    cy="50%"
                ...
                <circle
                    ...
                    className="prefix__puls"
                    style={{
                        animation: 'circle-small-scale 3s ease-in-out 2s infinite alternate',
                    }}
                    fill="#f7971e"
                    cx="50%"
                    cy="50%"
